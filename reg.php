...
<body>
    <div class="main">
        ...
        <form action="reg.php" method="post" class="form" onsubmit="return checkpassword()">
            <div class="form_items">
                <center>
                    <h1>User Registration</h1>
                    <input type="text" name="fname" id="fname" placeholder="First Name" class="input_box1" required>
                    <input type="text" name="lname" id="lname" placeholder="Last Name" class="input_box1" required>
                    <br>
                    <input type="email" name="email" id="email" placeholder="E-Mail" class="input_box2" required
                        pattern="[a-z 0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                    <br>
                    <input type="password" name="password" id="pwd" placeholder="Password" class="input_box2" required
                    ...
                    <select id="usertype" name="user" onchange="showhidden()" class="usertypedropbox" required>
